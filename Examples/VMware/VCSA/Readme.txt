...
4. Add CNAME & PTR for the VCSA FQDN name. I'm using vcsa.ctxlab.local on 192.168.1.200
5. Open CMD prompt
...
7. After ping test - Add CNAME & PTR for the VCSA FQDN name. I'm using vcsa.ctxlab.local on 192.168.1.200